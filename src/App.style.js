...
:root {
  --brand-primary-light: #fcf3e6;
  --brand-primary: #fcc404;
  --brand-primary-dark: #ec7c04;
  --brand-secondary-light: #caa48c;
  --brand-secondary: #bf7300;
  --lightest: #fff;
  --darkest: #000;
  --text-light: #ffce87;
  --text-base: #9d6d32;
  ...
  --dark: #34240c;
  --text-darkest: #976428;
  --link-transition: background-color 0.4s ease-in;
}
